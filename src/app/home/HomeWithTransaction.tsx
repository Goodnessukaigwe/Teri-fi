...
import { Eye, EyeOff, Copy, Bell, ChevronDown, ArrowUp, ArrowUpRight, Plus, Home, Send, Clock, Settings } from 'lucide-react';
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-2 mb-1">
                                            <span className="text-white text-sm font-medium">{transaction.type}</span>
                                        ...
                                        <div className="text-xs text-gray-500">to: {transaction.to}</div>
                                        <div className="text-xs text-gray-500 mt-0.5">{transaction.date}</div>
                                    </div>
                                </div>
                                <div className="text-right">
                                    <div className="text-white font-medium text-sm mb-1">{transaction.amount}</div>
                                    <div className="text-gray-500 text-xs">{transaction.nairaAmount}</div>
                                </div>
                            </div>
                        ))}
                    </div>
