...
const OnboardingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center text-center  text-white px-2">
      {/* Logo Box */}
      ...
      {/* Tagline */}
      <p className="text-gray-300 text-sm md:text-2xl mb-10">
